...
def deduction(
    ...
    if res[0] == False:
        ...
        pos = trouver_cle(
            dict_var_to_num, var_tester
        )  # On récupère les coordonnées de l'individu déduit
...
def boucle_deduction2(
    dict_var_to_num: dict, hc: HitmanKnowledge, clauses: ClauseBase, nb_vars: int
) -> ClauseBase:
    temp = clauses
